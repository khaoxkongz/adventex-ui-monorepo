                  ...
                  <div className="flex flex-col gap-4 p-8">
                    ...
                    <div className="text-muted-foreground w-full pb-4 text-lg">
                      <p className="indent-8">
                        ...
                        เราตระหนักถึงความสำคัญของ &ldquo;ภาษาที่สาม&ldquo; ในโลกอนาคต
                        ซึ่งไม่ได้เป็นเพียงเครื่องมือในการสื่อสาร แต่ยังเป็นสะพานที่เชื่อมโยงวัฒนธรรม ความรู้
                        และโอกาสระดับโลก
                      </p>
                      <p className="indent-8">
                        ในระหว่างที่เราศึกษาในต่างประเทศนั้น เราพบว่า &ldquo;การไปเรียนต่างประเทศ&ldquo;
                        ยังเป็นความฝันที่ดูไกลเกินเอื้อมสำหรับหลายคน ด้วยข้อจำกัดทางภาษา กระบวนการที่ซับซ้อน
                        และความไม่มั่นใจของผู้เรียน เราจึงมีเป้าหมายสำคัญที่จะเปลี่ยนมุมมองนี้
        ...
        <div className="container py-4 xl:py-6 2xl:py-4">
          <BlurFade className="mx-auto grid max-w-prose gap-4 text-center">
            ...
            <p className="text-muted-foreground indent-8 text-lg">
              Adventex มุ่งมั่นที่จะพัฒนาบริการที่ช่วยสนับสนุนการเรียนรู้และการเตรียมตัวสำหรับการศึกษาต่อในต่างประเทศ
              ไม่ว่าจะเป็น การพัฒนาทักษะภาษาที่สาม
              การให้คำปรึกษาด้านการศึกษาและรวมถึงผู้ดูแลที่ช่วยเหลือในขณะเราอยู่ต่างประเทศ ทำให้ผู้เดินทางเกิดความสบายใจ
