  ...
  return (
    <div className="container-wrapper">
      <div className="container py-4 xl:py-6 2xl:py-4">
        <div
          className={`grid gap-6 ${getGridClass(layout as "grid" | "list")}`}
        >
...
function ProgramCardsPagination() {
  const { layout, currentPage, setCurrentPage, filteredPrograms } =
    usePrograms()
  ...
  return (
    ...
    >
      <div className="text-muted-foreground size-full text-sm md:hidden">
        ...
        {Math.min(currentPage * itemsPerPage, filteredPrograms.length)} จาก{" "}
      ...
      <div className="text-muted-foreground hidden size-full text-sm md:block">
        ...
        จากทั้งหมด {filteredPrograms.length} รายการ
      </div>
